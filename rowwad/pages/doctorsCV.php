...
<div class="app-bar">
    ...
    <div class="container">
        ...
        <div class="eduExp" id='eduExp'>
            <h1><i class="fas fa-school"></i> الخبرات التدريسية</h1>
            <hr class='dviderLine'>

            <?php 
            drawElement($data[0]['edu_exp'], 'fa-school', "الخبرات التدريسية",'edu_exp');
        ...
        <div class="practicalExp" id='practicalExp'>
            <h1><i class="fas fa-circle-notch"></i> الخبرات العملية</h1>
            <hr class='dviderLine'>

            <?php 
            drawElement($data[0]['practical_exp'], 'fa-circle-notch', "الخبرات العملية",'practical_exp');
        //    $string = $data[0]['practical_exp'];
        //    $delimiter = "\n";
        ...
        //     // Use a for loop to iterate through the array
        //     for ($i = 0; $i < count($array); $i++) {
        //         echo '<p class="itemTitle"> <i class="fas fa-circle-notch itemIcons"></i> ' . $array[$i] . "</p>";
        //     }
        ...
        <div class="memberships" id='memberships'>
            <h1><i class="fas fa-handshake"></i> العضويات المهنية</h1>
            <hr class='dviderLine'>
            <?php 
                drawElement($data[0]['memberships'], 'fa-handshake', "العضويات المهنية",'memberships');
            ?>
            <?php 
        //    $string = $data[0]['memberships'];
        //    $delimiter = "\n";
        ...
        //     // Use a for loop to iterate through the array
        //     for ($i = 0; $i < count($array); $i++) {
        //         echo '<p class="itemTitle"> <i class="fas fa-handshake itemIcons"></i> ' . $array[$i] . "</p>";
        //     }
                    
           ?>
        </div>
        <div class="books" id='books'>
            <h1><i class="fas fa-pen-nib"></i> المؤلفات العلمية</h1>
            <hr class='dviderLine'>
            <?php 
                drawElement($data[0]['books'], 'fa-pen-nib', "المؤلفات العلمية",'books');
            ?>
            <?php 
        //    $string = $data[0]['books'];
        //    $delimiter = "\n";
        ...
        //     // Use a for loop to iterate through the array
        //     for ($i = 0; $i < count($array); $i++) {
        //         echo '<p class="itemTitle"> <i class="fas fa-pen-nib itemIcons"></i> ' . $array[$i] . "</p>";
        //     }
        ...
        <div class="discussions" id='discussions'>
            <h1><i class="fas fa-book"></i> مناقشات الرسائل العلمية</h1>
            <hr class='dviderLine'>
            <?php 
                drawElement($data[0]['discussions'], 'fa-book', "مناقشات الرسائل العلمية",'discussions');
            ?>
        </div>
